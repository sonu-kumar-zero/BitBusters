...
const Navbar = () => {
  return (
    <div className="flex justify-between px-[40px] py-[10px] border-b">
      ...
      <div className="flex gap-10 items-center text-lg font-semibold">
        ...
        <button className="hover:bg-[#5b59ea] bg-[#1b1a55] text-white px-3 py-1 pb-[6px] text-[16px] rounded-[10px] font-semibold">
          Sign Up
        </button>
      </div>
    </div>
